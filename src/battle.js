            ...
            if( this.puzzle.jewelyStack.length > 0 ){
                ...
                if( !this.puzzle.myturn ){
                    ...
                    if( this.puzzle.turnend && !this.puzzle.myturn ){
                        var colum;
                        var row;
                        for( colum = 0; colum < this.puzzle.columNum; colum++ ){
                            for(row = 0; row < this.puzzle.rowNum; row++ ){
                                var jewelry = this.puzzle.jewelrySpriteArray[colum][row];
                                jewelry.setPosition( this.puzzle.getPosition( colum, row ) );
                            }
                        }
